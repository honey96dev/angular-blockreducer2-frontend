...
@Component({
  selector: 'home-market-linear-chart',
  templateUrl: './market-linear-chart.component.html',
  styleUrls: ['./market-linear-chart.component.scss']
})
export class MarketLinearChartComponent implements OnInit {
  strings = strings;
  form: FormGroup;
  arrow = {
    show: false,
  ...
  public constructor(private titleService: Title,
    ...
    titleService.setTitle(`${strings.marketSentiment} ${strings.linearChart}-${strings.siteName}`);
    self = this;
  }
  ...
  onSubmit() {
    ...
    console.log('market-linear-chart', new Date());
